...
public class TelaMenuPrincipalMedico extends JFrame {
	...
	public TelaMenuPrincipalMedico(Usuario login) {
		...
		btnAtender.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				int n = JOptionPane.showConfirmDialog(null, "Deseja confirma Atendimento" + consultaClick.getPaciente().getNome()+ " ", "",
		...
		JLabel lblNewLabel_3_1 = new JLabel("  Vila de espera : 1");
		lblNewLabel_3_1.setFont(new Font("Tahoma", Font.BOLD, 16));
		lblNewLabel_3_1.setBounds(0, 0, 360, 153);
		panel_1_6_1.add(lblNewLabel_3_1);
		...
		btnCancelar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int n = JOptionPane.showConfirmDialog(null, "Deseja cancelar o  atendimento" + consultaClick.getPaciente().getNome()+ " ", "",
						JOptionPane.YES_NO_OPTION);
				if(n== JOptionPane.YES_OPTION) {
					agendaDao = new AgendaDao();
		...
		JLabel lblNewLabel_4 = new JLabel(" Total  de consulta(dia) : "+totaldeConsulta);
		lblNewLabel_4.setFont(new Font("Tahoma", Font.BOLD, 16));
		lblNewLabel_4.setBounds(0, 0, 360, 150);
		panel_1_6.add(lblNewLabel_4);
		panel_1_2.setLayout(null);
		
		JLabel lblNewLabel_2 = new JLabel("  Não presentes :"+(totaldeConsulta-filaDeEspera));
		...
		lblNewLabel.setFont(new Font("Tahoma", Font.BOLD, 16));
		lblNewLabel.setBounds(0, 0, 360, 150);
	...
	private void atualizarTabelaDia() {
		...
		DefaultTableModel tabela = new DefaultTableModel(new Object[][] {}, new String[] { "Nome", "CPF","Data" ,"Hora" , "Status" });
		listConulta = new ArrayList<>();
		agendaDao = new AgendaDao();
		filaDeEspera =  agendaDao.consultarFilaDeEspera();
		...
		for (i = 0; i < listConulta.size(); i++) {
			...
			tabela.addRow(new Object[] { consulta.getPaciente().getNome(), consulta.getPaciente().getCpf(), consulta.getDate(),consulta.getHora() , consulta.getPresença()});
