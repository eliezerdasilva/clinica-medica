...
public class TelaCadastroPaciente extends JFrame {
	...
	public TelaCadastroPaciente() {
		...
		JComboBox btnConvenio = new JComboBox();
		panel_3.add(btnConvenio, "cell 6 1,grow");
		...
		btnCadastrarPaciente.setFont(new Font("Tahoma", Font.BOLD, 16));
		panel_5.add(btnCadastrarPaciente, "cell 1 7 2 1,grow");
