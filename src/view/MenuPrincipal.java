...
public class MenuPrincipal extends JFrame {
	...
	public MenuPrincipal(Usuario login) {		
		...
		JMenuItem mntmNewMenuItem_10 = new JMenuItem("Consultar consultas");
		...
		lblNewLabel.setBounds(274, 275, 60, 14);
		contentPane.add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel(login.getUsuario());
		lblNewLabel_1.setBounds(325, 275, 46, 14);
